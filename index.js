...
module.exports = options => {
  ...
  options.length = options && options.length ? options.length : 15 /* recommended to be uncrackable */;
  ...
  if (options.excludeChars instanceof Array) {
    options.excludeChars.forEach(c => {
      if (typeof c === 'string' || c instanceof String) {
  ...
  options.excludeChars.forEach(c => chars = chars.replace(c, ""));
